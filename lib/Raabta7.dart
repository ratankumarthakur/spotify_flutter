...
class raabta7 extends StatefulWidget {
  const raabta7({super.key});

  @override
  State<raabta7> createState() => _raabta7State();
}

class _raabta7State extends State<raabta7> {
  ...
  Future initPlayer() async{
    player=AudioPlayer();
    path=AssetSource('music/atif/Dekhte Dekhte.mp3');
