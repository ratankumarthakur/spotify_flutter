...
class raabta33 extends StatefulWidget {
  const raabta33({super.key});

  @override
  State<raabta33> createState() => _raabta33State();
}

class _raabta33State extends State<raabta33> {
  ...
  Future initPlayer() async{
    player=AudioPlayer();
    path=AssetSource('music/jubin/gamhaiyakhusi.mp3');
