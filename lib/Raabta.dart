...
class raabta extends StatefulWidget {
  const raabta({super.key});

  @override
  State<raabta> createState() => _raabtaState();
}

class _raabtaState extends State<raabta> {
  ...
  Future initPlayer() async{
    player=AudioPlayer();
    path=AssetSource('music/arijit/Darkhast.mp3');
