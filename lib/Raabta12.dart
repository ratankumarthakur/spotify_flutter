...
class raabta12 extends StatefulWidget {
  const raabta12({super.key});

  @override
  State<raabta12> createState() => _raabta12State();
}

class _raabta12State extends State<raabta12> {
  ...
  Future initPlayer() async{
    player=AudioPlayer();
    path=AssetSource('music/atif/Toota Jo Kabhi Tara.mp3');
