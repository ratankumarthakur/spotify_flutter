...
class raabta31 extends StatefulWidget {
  const raabta31({super.key});

  @override
  State<raabta31> createState() => _raabta31State();
}

class _raabta31State extends State<raabta31> {
  ...
  Future initPlayer() async{
    player=AudioPlayer();
    path=AssetSource('music/jubin/bahotaae.mp3');
