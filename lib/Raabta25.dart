...
class raabta25 extends StatefulWidget {
  const raabta25({super.key});

  @override
  State<raabta25> createState() => _raabta25State();
}

class _raabta25State extends State<raabta25> {
  ...
  Future initPlayer() async{
    player=AudioPlayer();
    path=AssetSource('music/justin/baby.mp3');
