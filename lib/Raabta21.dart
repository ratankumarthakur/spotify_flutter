...
class raabta21 extends StatefulWidget {
  const raabta21({super.key});

  @override
  State<raabta21> createState() => _raabta21State();
}

class _raabta21State extends State<raabta21> {
  ...
  Future initPlayer() async{
    player=AudioPlayer();
    path=AssetSource('music/guru/budhusaman.mp3');
