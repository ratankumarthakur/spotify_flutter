...
class raabta13 extends StatefulWidget {
  const raabta13({super.key});

  @override
  State<raabta13> createState() => _raabta13State();
}

class _raabta13State extends State<raabta13> {
  ...
  Future initPlayer() async{
    player=AudioPlayer();
    path=AssetSource('music/armaan/dilmehotum.mp3');
