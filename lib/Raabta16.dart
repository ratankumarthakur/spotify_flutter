...
class raabta16 extends StatefulWidget {
  const raabta16({super.key});

  @override
  State<raabta16> createState() => _raabta16State();
}

class _raabta16State extends State<raabta16> {
  ...
  Future initPlayer() async{
    player=AudioPlayer();
    path=AssetSource('music/armaan/humnashe.mp3');
