...
class raabta6 extends StatefulWidget {
  const raabta6({super.key});

  @override
  State<raabta6> createState() => _raabta6State();
}

class _raabta6State extends State<raabta6> {
  ...
  Future initPlayer() async{
    player=AudioPlayer();
    path=AssetSource('music/arijit/vo_din_bhi.mp3');
