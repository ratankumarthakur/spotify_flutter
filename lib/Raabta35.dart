...
class raabta35 extends StatefulWidget {
  const raabta35({super.key});

  @override
  State<raabta35> createState() => _raabta35State();
}

class _raabta35State extends State<raabta35> {
  ...
  Future initPlayer() async{
    player=AudioPlayer();
    path=AssetSource('music/jubin/humnavamere.mp3');
