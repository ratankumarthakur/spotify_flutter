...
class raabta19 extends StatefulWidget {
  const raabta19({super.key});

  @override
  State<raabta19> createState() => _raabta19State();
}

class _raabta19State extends State<raabta19> {
  ...
  Future initPlayer() async{
    player=AudioPlayer();
    path=AssetSource('music/guru/aajsajeya.mp3');
