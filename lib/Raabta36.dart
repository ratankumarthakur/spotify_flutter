...
class raabta36 extends StatefulWidget {
  const raabta36({super.key});

  @override
  State<raabta36> createState() => _raabta36State();
}

class _raabta36State extends State<raabta36> {
  ...
  Future initPlayer() async{
    player=AudioPlayer();
    path=AssetSource('music/jubin/tamo.mp3');
