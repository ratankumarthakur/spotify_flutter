...
class raabta22 extends StatefulWidget {
  const raabta22({super.key});

  @override
  State<raabta22> createState() => _raabta22State();
}

class _raabta22State extends State<raabta22> {
  ...
  Future initPlayer() async{
    player=AudioPlayer();
    path=AssetSource('music/guru/dekhlena.mp3');
