...
class raabta27 extends StatefulWidget {
  const raabta27({super.key});

  @override
  State<raabta27> createState() => _raabta27State();
}

class _raabta27State extends State<raabta27> {
  ...
  Future initPlayer() async{
    player=AudioPlayer();
    path=AssetSource('music/guru/bolna.mp3');
