...
class raabta4 extends StatefulWidget {
  const raabta4({super.key});

  @override
  State<raabta4> createState() => _raabta4State();
}

class _raabta4State extends State<raabta4> {
  ...
  Future initPlayer() async{
    player=AudioPlayer();
    path=AssetSource('music/arijit/Raabta.mp3');
