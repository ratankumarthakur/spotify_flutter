...
class raabta5 extends StatefulWidget {
  const raabta5({super.key});

  @override
  State<raabta5> createState() => _raabta5State();
}

class _raabta5State extends State<raabta5> {
  ...
  Future initPlayer() async{
    player=AudioPlayer();
    path=AssetSource('music/arijit/suraj_dooba.mp3');
