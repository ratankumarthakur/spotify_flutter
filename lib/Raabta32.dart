...
class raabta32 extends StatefulWidget {
  const raabta32({super.key});

  @override
  State<raabta32> createState() => _raabta32State();
}

class _raabta32State extends State<raabta32> {
  ...
  Future initPlayer() async{
    player=AudioPlayer();
    path=AssetSource('music/jubin/diljaniye.mp3');
