...
class raabta29 extends StatefulWidget {
  const raabta29({super.key});

  @override
  State<raabta29> createState() => _raabta29State();
}

class _raabta29State extends State<raabta29> {
  ...
  Future initPlayer() async{
    player=AudioPlayer();
    path=AssetSource('music/justin/Kaun Tujhe (M.S. Dhoni - The Untold Story) 320Kbps.mp3');
