...
class raabta18 extends StatefulWidget {
  const raabta18({super.key});

  @override
  State<raabta18> createState() => _raabta18State();
}

class _raabta18State extends State<raabta18> {
  ...
  Future initPlayer() async{
    player=AudioPlayer();
    path=AssetSource('music/armaan/sauaasmano.mp3');
