...
class raabta30 extends StatefulWidget {
  const raabta30({super.key});

  @override
  State<raabta30> createState() => _raabta30State();
}

class _raabta30State extends State<raabta30> {
  ...
  Future initPlayer() async{
    player=AudioPlayer();
    path=AssetSource('music/justin/TumMile.mp3');
