...
class raabta17 extends StatefulWidget {
  const raabta17({super.key});

  @override
  State<raabta17> createState() => _raabta17State();
}

class _raabta17State extends State<raabta17> {
  ...
  Future initPlayer() async{
    player=AudioPlayer();
    path=AssetSource('music/armaan/itnisibaathai.mp3');
