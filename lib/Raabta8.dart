...
class raabta8 extends StatefulWidget {
  const raabta8({super.key});

  @override
  State<raabta8> createState() => _raabta8State();
}

class _raabta8State extends State<raabta8> {
  ...
  Future initPlayer() async{
    player=AudioPlayer();
    path=AssetSource('music/atif/Le Ja Tu Mujhe.mp3');
