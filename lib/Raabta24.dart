...
class raabta24 extends StatefulWidget {
  const raabta24({super.key});

  @override
  State<raabta24> createState() => _raabta24State();
}

class _raabta24State extends State<raabta24> {
  ...
  Future initPlayer() async{
    player=AudioPlayer();
    path=AssetSource('music/guru/girlineedyou.mp3');
