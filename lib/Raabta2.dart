...
class raabta2 extends StatefulWidget {
  const raabta2({super.key});

  @override
  State<raabta2> createState() => _raabta2State();
}

class _raabta2State extends State<raabta2> {
  ...
  Future initPlayer() async{
    player=AudioPlayer();
    path=AssetSource('music/arijit/Kalank.mp3');
