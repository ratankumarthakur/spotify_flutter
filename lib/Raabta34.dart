...
class raabta34 extends StatefulWidget {
  const raabta34({super.key});

  @override
  State<raabta34> createState() => _raabta34State();
}

class _raabta34State extends State<raabta34> {
  ...
  Future initPlayer() async{
    player=AudioPlayer();
    path=AssetSource('music/jubin/halkihalkisi.mp3');
