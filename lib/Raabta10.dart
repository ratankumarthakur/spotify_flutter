...
class raabta10 extends StatefulWidget {
  const raabta10({super.key});

  @override
  State<raabta10> createState() => _raabta10State();
}

class _raabta10State extends State<raabta10> {
  ...
  Future initPlayer() async{
    player=AudioPlayer();
    path=AssetSource('music/atif/Tera Hone Laga Hoon.mp3');
            ...
            children: [Container(width: double.infinity,height: 300,color: Colors.black,
              ...
              Row(
                ...
                children: [
                  ...
                  }, icon: Icon(Icons.fast_forward,color: Colors.green,size: 20,)),
              ...
              Container(width:200,height: 200,decoration: BoxDecoration(
                  ...
                  child: RiveAnimation.asset("assets/rive/cat.riv"))
