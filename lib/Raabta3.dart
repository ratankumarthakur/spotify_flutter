...
class raabta3 extends StatefulWidget {
  const raabta3({super.key});

  @override
  State<raabta3> createState() => _raabta3State();
}

class _raabta3State extends State<raabta3> {
  ...
  Future initPlayer() async{
    player=AudioPlayer();
    path=AssetSource('music/arijit/mila_to_hai_na.mp3');
