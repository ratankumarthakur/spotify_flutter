...
class raabta23 extends StatefulWidget {
  const raabta23({super.key});

  @override
  State<raabta23> createState() => _raabta23State();
}

class _raabta23State extends State<raabta23> {
  ...
  Future initPlayer() async{
    player=AudioPlayer();
    path=AssetSource('music/guru/Firecracker.mp3');
