...
class raabta26 extends StatefulWidget {
  const raabta26({super.key});

  @override
  State<raabta26> createState() => _raabta26State();
}

class _raabta26State extends State<raabta26> {
  ...
  Future initPlayer() async{
    player=AudioPlayer();
    path=AssetSource('music/justin/chorikiya.mp3');
