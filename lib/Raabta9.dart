...
class raabta9 extends StatefulWidget {
  const raabta9({super.key});

  @override
  State<raabta9> createState() => _raabta9State();
}

class _raabta9State extends State<raabta9> {
  ...
  Future initPlayer() async{
    player=AudioPlayer();
    path=AssetSource('music/atif/O_sathi.mp3');
