...
class raabta11 extends StatefulWidget {
  const raabta11({super.key});

  @override
  State<raabta11> createState() => _raabta11State();
}

class _raabta11State extends State<raabta11> {
  ...
  Future initPlayer() async{
    player=AudioPlayer();
    path=AssetSource('music/atif/Tere Bin.mp3');
