...
class raabta14 extends StatefulWidget {
  const raabta14({super.key});

  @override
  State<raabta14> createState() => _raabta14State();
}

class _raabta14State extends State<raabta14> {
  ...
  Future initPlayer() async{
    player=AudioPlayer();
    path=AssetSource('music/armaan/hawaen.mp3');
