...
class raabta15 extends StatefulWidget {
  const raabta15({super.key});

  @override
  State<raabta15> createState() => _raabta15State();
}

class _raabta15State extends State<raabta15> {
  ...
  Future initPlayer() async{
    player=AudioPlayer();
    path=AssetSource('music/armaan/humnahi.mp3');
